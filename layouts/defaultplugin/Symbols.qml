...
KeyboardLayoutLoader {
    ...
    Component {
        ...
        KeyboardLayout {
            ...
            KeyboardRow {
                Key { displayText: "1/2"; functionKey: true; noKeyEvent: true; onClicked: secondPage = !secondPage; secondaryStyle: true }
    ...
    Component {
        ...
        KeyboardLayout {
            ...
            KeyboardRow {
                Key { displayText: "2/2"; functionKey: true; noKeyEvent: true; onClicked: secondPage = !secondPage; secondaryStyle: true }
                Key { key: 0x2122; text: "™" }
                Key { key: 0x00AE; text: "®" }
